...
| **6 Months** | 6 months | Biannual billing |
| **Yearly** | 12 months | Annual billing, often with discounts |
| **One Time** | One-off payment | Digital products, courses, lifetime access |

<Tip>
  We can also add custom billing periods such as weekly, daily, or 28 days upon request. Contact [hi@kelviq.com](mailto:hi@kelviq.com) to enable these options.
</Tip>
