...
When creating a checkout session through the API, use the optional `successUrl` field. You can also provide `cancelUrl` to redirect the customer if they cancel payment.
