...
2. The Seller must provide the requested information within the timeframe specified by Kelviq (typically 3-5 business days)
...
The Seller is financially responsible for all Chargebacks related to their Products. This includes the original transaction amount, any chargeback fees imposed by payment networks or processors, and any costs incurred by Kelviq in responding to the dispute.
