...
| Kelviq Platform Fee (3.9%) | -$3.90 |
| **Seller Net Revenue** | **$96.10** |
...
<Steps>
  ...
  <Step title="Notification Chain">
    Bank notifies Stripe, Stripe notifies Kelviq.
  </Step>
  <Step title="Evidence Collection">
    Seller provides evidence within 3-5 business days.
  </Step>
  ...
  <Step title="Resolution">
    **Won:** Funds returned to Kelviq/Seller. **Lost:** Chargeback amount + fee deducted from Seller's balance.
  </Step>
</Steps>
...
| Statement descriptor | Set on the PaymentIntent, shows "KELVIQ" or "KELVIQ* [suffix]" |
