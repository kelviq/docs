...
kelviq builds on top of Stripe by adding a few key building blocks.  
...
When they subscribe in Stripe, kelviq maps that subscription to the customer record automatically.

---

## Sync with Stripe

kelviq works on top of Stripe.  
Everything you create in kelviq — products, plans, features, entitlements, promotions — is synced to Stripe when you publish changes.  

You don’t need to set up anything manually in Stripe. Just connect once, and kelviq keeps data in sync.
