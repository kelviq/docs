...
1. In the dashboard, go to [**Monetization → Pricing tables**](https://app.kelviq.com/pricing-tables)
...
1. In the dashboard, go to [**Monetization → Offerings**](https://app.kelviq.com/offerings)
