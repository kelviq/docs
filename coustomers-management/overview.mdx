...
This section lists active and past plans. It shows the status, such as Active or Canceled, and the relevant dates. For a cancelled subscription, the date it was cancelled appears alongside the status.
