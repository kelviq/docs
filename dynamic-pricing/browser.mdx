...
<Warning>
  **Feature Status:** The ability to create targeting rules based on Browser, Platform, or Operating System is an upcoming feature and is not yet available. The steps below are illustrative of how this functionality might work within the kelviq Targeting Rules framework once released.
</Warning>
...
1.  From the side navigation menu, go to **Monetization > Targeting rules**.
    * `[Image: kelviq navigation sidebar with "Targeting rules" highlighted under "Monetization".]`
...
1.  **Navigate to Offerings:**
    ...
    * `[Image: kelviq navigation sidebar with "Offerings" highlighted.]`
...
6.  **Integrate:** Use this Offering ID in your application. When this Offering is requested, kelviq would (once the feature is live) evaluate the associated `Android User - 10% Mobile Discount` rule.
