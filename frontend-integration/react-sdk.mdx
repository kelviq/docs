...
- `accessToken: string | null`
  - Your **Client API Key** for authenticating requests to the Kelviq API. This key is safe to expose in client-side code. You can find it in the [Developers](https://app.kelviq.com/settings/developers) section of your Kelviq dashboard. Never use your Server API Key in client-side code.
...
``` ts
import type { Entitlement, EntitlementMap, EntitlementsResponse } from '@kelviq/react-sdk';
```
