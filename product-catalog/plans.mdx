...
The order of entitlement is critical as it determines their default display order in **pricing tables** that are rendered using kelviq. You can reorder entitlements to highlight your most important entitlements first. This ordering can be managed in two places:
...
While entitlements have a default name, you often need more customer-friendly or descriptive text for your pricing tables. kelviq allows you to override the default text for any entitlement on a specific pricing table.
