...
This guide provides a complete overview of how to view, add, edit, and understand individual customer details and their associated subscriptions, entitlements, and usage within kelviq.
## Viewing the List of Customers

To access and manage your customer data, select the **Customers** section from the main left navigation pane in the kelviq dashboard.
...
To manually add a new customer record to kelviq:
...
2.  The "Create customer" modal window will appear. You need to fill in the following details:
    ...
    * **Identifier:** This unique ID is used by kelviq to reference the customer internally and via the API. It is auto-generated based on the customer name; however, you can edit it before creation. It's recommended to use this identifier to link to an existing customer ID in your own system if applicable.
...
* **Created / Last updated date:** Timestamps indicating when the customer record was created in kelviq and when it was last modified.
