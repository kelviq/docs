---
title: "Stripe Entitlements vs kelviq Entitlements"
description: "Stripe handles payments and basic feature access. kelviq expands that with usage-based limits, config-based features, and developer-first SDKs."
---
...
| Capability | Stripe | kelviq | Notes |
|------------|:------:|:-----------:|-------|
...
| Feature Name            | Type     | Description                                         | Example Value         | kelviq | Stripe |
|-------------------------|----------|-----------------------------------------------------|-----------------------|:-----------:|:------:|
...
You still use Stripe for payments — and kelviq to power everything else around *what users get* after they pay.
