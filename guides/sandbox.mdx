...
Use a daily billing interval to test a renewal without waiting for a monthly or yearly billing cycle.
...
<Note>
  Any sandbox organization can request Daily billing. It is not limited to selected accounts. If **Daily** does not appear in the dashboard, contact [Kelviq support](mailto:hi@kelviq.com) to have it enabled.
</Note>
