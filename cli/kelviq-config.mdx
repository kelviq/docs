...
| `reset` | enum | no | Usage reset cadence: `NEVER`, `EVERY_DAY`, `EVERY_MONTH`, `EVERY_QUARTER`, `EVERY_YEAR`. |
...
<Info>
A pulled config reproduces your remote prices in full, including nested charge structures. You rarely need to author `chargeCatalogPrice` by hand — pull an existing plan and adapt it.
</Info>
