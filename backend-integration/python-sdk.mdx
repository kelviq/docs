...
Retrieves a paginated list of subscriptions, optionally filtered by customer.
...
* `customerId` (str): Filters subscriptions by the client-defined customer identifier.
