...
<Update label="v1.7.9" description="September 15, 2026">
...
The signing secret used to verify the `Kelviq-Signature` header is generated automatically and returned in the create response.

</Update>

<Update label="v1.7.8" description="September 10, 2026">
...
<Update label="v1.7.7" description="September 7, 2026">
