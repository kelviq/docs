...
rss: true
---
<Update label="v1.17" description="August 21, 2026">
...
<Update label="v1.16" description="August 7, 2026">
...
On the API side, subscription responses now include cancellation metadata: when the subscription was cancelled, whether the customer or the merchant initiated it, and any feedback the customer gave. See the [API changelog](/changelog/api) entry for v1.7.0.

</Update>

<Update label="v1.15" description="July 31, 2026">
...
<Update label="v1.14" description="July 24, 2026">
